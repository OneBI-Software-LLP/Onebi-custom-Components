    ...
    >
      <div
        style={{
          ...
          ...({ "--orbit-r": `${orbitR}px` } as React.CSSProperties),
...
function SpinnerGraphic({ type, sizePx, sw, color, trackC, dur, easing, paused }: { type: SpinnerType; sizePx: number; sw: number; color: string; trackC: string; dur: number; easing: string; paused: boolean }) {
